...
import {
  Plus, Search, TrendingUp, TrendingDown, Minus, ArrowRight,
...
export default function AnalysisPage() {
  ...
  const listWeekYear = getISOWeekYear(listWeekDate);

  // 7 days for the selected week (Mon→Sun)
  ...
  // Analyses for the selected week, sorted Mon→Sun
  ...
  }, [filtered, listWeekStart.getTime(), listWeekEnd.getTime()]);

  // Analyses grouped by day within the selected week
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {/* Period filter — only in grid mode */}
        {viewMode === "grid" && (
          <div className="flex rounded-lg border border-border/50 overflow-hidden">
                ...
                {listWeekDays.map((d, i) => {
                  ...
                  return (
                    <span
                      ...
                      className={cn(
                        "inline-flex items-center justify-center w-7 h-7 rounded-lg text-[10px] font-semibold transition-colors",
                        isToday
