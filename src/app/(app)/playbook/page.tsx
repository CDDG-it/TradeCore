    ...
    <div className="space-y-2">
      ...
      <div className="flex gap-2">
        <input
          ...
          style={{ background: "oklch(0.09 0.014 252)", border: "1px solid oklch(0.26 0.025 252)", color: "oklch(0.93 0.008 252)" }}
        />
        <button
          type="button"
          onClick={add}
          className="px-3 py-2 rounded-lg text-sm font-medium transition-colors"
          style={{ background: "oklch(0.20 0.025 252)", color: "oklch(0.65 0.04 252)" }}
        >
        ...
        <div className="flex flex-wrap gap-1.5">
          {tags.map((t) => (
            <span
              ...
              style={{ background: "oklch(0.18 0.025 252)", color: "oklch(0.75 0.04 252)", border: "1px solid oklch(0.28 0.025 252)" }}
            >
              {t}
              <button
                type="button"
    ...
    <div className="space-y-2">
        ...
        <div className="space-y-1.5">
          {items.map((item, i) => (
            <div
              ...
              style={{ background: "oklch(0.10 0.014 252)", border: "1px solid oklch(0.22 0.025 252)" }}
            >
              <span
                className="w-5 h-5 rounded-full flex items-center justify-center text-xs font-bold shrink-0"
                style={{ background: "oklch(0.74 0.13 82 / 0.15)", color: "oklch(0.74 0.13 82)" }}
              >
                {i + 1}
              </span>
      ...
      <div className="flex gap-2">
        <input
          ...
          style={{ background: "oklch(0.09 0.014 252)", border: "1px solid oklch(0.26 0.025 252)", color: "oklch(0.93 0.008 252)" }}
        />
        <button type="button" onClick={add} className="px-3 py-2 rounded-lg text-sm font-medium transition-colors" style={{ background: "oklch(0.20 0.025 252)", color: "oklch(0.65 0.04 252)" }}>
          <Plus className="w-4 h-4" />
        </button>
      </div>
    </div>
        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              style={
                active
                  ? { background: "oklch(0.74 0.13 82 / 0.20)", color: "oklch(0.74 0.13 82)", border: "1px solid oklch(0.74 0.13 82 / 0.40)" }
                  : { background: "oklch(0.09 0.014 252)", color: "oklch(0.50 0.04 252)", border: "1px solid oklch(0.22 0.025 252)" }
              }
            >
              {opt}
            </button>
    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="flex items-start justify-between gap-4 animate-fade-up">
        ...
        <button
          ...
          style={{
            background: saved ? "oklch(0.58 0.17 145)" : "oklch(0.74 0.13 82)",
      ...
      {/* Trader Type */}
      <Section icon={Target} title="Who are you as a trader?" color="oklch(0.72 0.14 220)">
        <div className="space-y-2">
              ...
              <button
                ...
                style={
                  form.trader_type === value
                    ? { background: "oklch(0.72 0.14 220 / 0.15)", border: "1px solid oklch(0.72 0.14 220 / 0.50)", outline: "2px solid oklch(0.72 0.14 220 / 0.30)" }
                    : { background: "oklch(0.09 0.014 252)", border: "1px solid oklch(0.22 0.025 252)" }
                }
              >
      ...
      {/* Edge + Criteria */}
      <Section icon={Zap} title="Your edge and criteria" color="oklch(0.74 0.13 82)">
        <TagInput
      ...
      <div className="flex justify-end pb-4">
        <button
          ...
          style={{
            background: saved ? "oklch(0.58 0.17 145)" : "linear-gradient(135deg, oklch(0.74 0.13 82) 0%, oklch(0.82 0.16 82) 100%)",
            color: "oklch(0.08 0.014 252)",
            boxShadow: "0 4px 20px oklch(0.74 0.13 82 / 0.35)",
          }}
        >
          <Save className="w-4 h-4" />
          {saved ? "Saved!" : "Save playbook"}
