              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                {form.discipline && (
                  <div className="flex items-center gap-2 flex-1 min-w-0">
                    <div className="flex-1 h-1.5 rounded-full overflow-hidden max-w-28" style={{ background: "oklch(0.18 0.030 28)" }}>
                      <div
                ...
                {DISCIPLINE_CHECKS.map(({ key, label }) => {
                  ...
                  return (
                    <button
                      ...
                      style={{
                        background: checked ? "oklch(0.58 0.17 145 / 0.08)" : "oklch(0.08 0.018 28)",
                        border: `1px solid ${checked ? "oklch(0.58 0.17 145 / 0.25)" : "oklch(0.18 0.030 28)"}`,
                      }}
                    >
                      <div
                        ...
                        style={
                          checked
                            ...
                            : { background: "transparent", border: "1.5px solid oklch(0.35 0.03 28)" }
                        }
                      >
                      ...
                      <span
                        ...
                        style={{ color: checked ? "oklch(0.90 0.008 28)" : "oklch(0.65 0.04 28)" }}
                      >
                        {label}
                      </span>
                    </button>
