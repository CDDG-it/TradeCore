...
import { MarketTransition } from "@/components/landing/market-transitions";
  ...
  return (
    <div className={`${inter.variable} marketing-page min-h-screen overflow-x-clip bg-[#0b1120] text-white`}>
      ...
      <main id="main">
        ...
        <MarketTransition direction="into-light" />
        <div className="marketing-light-flow text-[#0b1120]">
          <section id="the-approach" className="px-6 pb-8 pt-16 sm:px-10 md:pb-10 md:pt-24 lg:px-12">
          ...
          <section id="mindscore" className="px-6 pb-28 pt-8 sm:px-10 md:pb-40 md:pt-10 lg:px-12">
            <div className="mx-auto max-w-[1260px]">
        ...
        <MarketTransition direction="into-dark" />
