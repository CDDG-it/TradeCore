...
function PreviewFrame({ children, title, icon: Icon, color }: {
  ...
  return (
    <div
      ...
      style={{
        background: "oklch(0.10 0.016 252)",
        border: "1px solid oklch(0.20 0.022 252)",
      }}
    >
      <div
        className="flex items-center gap-2.5 px-4 py-3"
        style={{ borderBottom: "1px solid oklch(0.18 0.020 252)" }}
      >
        <div
        ...
        <div className="ml-auto flex gap-1.5">
          <div className="w-2.5 h-2.5 rounded-full" style={{ background: "oklch(0.25 0.025 252)" }} />
          <div className="w-2.5 h-2.5 rounded-full" style={{ background: "oklch(0.25 0.025 252)" }} />
          <div className="w-2.5 h-2.5 rounded-full" style={{ background: "oklch(0.25 0.025 252)" }} />
        </div>
      </div>
          ...
          {habits.map(({ label, done }) => (
            <div key={label} className="flex items-center gap-2">
              <div
                ...
                style={{
                  background: done ? "oklch(0.58 0.17 145)" : "oklch(0.14 0.018 252)",
                  border: done ? "none" : "1px solid oklch(0.25 0.025 252)",
                }}
              >
      ...
      <section className="relative z-10 px-6 pb-28">
        <div className="mx-auto max-w-6xl">
          <div className="text-center mb-14">
            ...
            <p className="text-sm max-w-sm mx-auto" style={{ color: "oklch(0.50 0.04 252)" }}>
