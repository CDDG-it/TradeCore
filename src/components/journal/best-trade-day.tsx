          ...
          <div className="space-y-5">
            ...
            >
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  The trade you took was the best play available that day.
                </p>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11px] font-medium text-muted-foreground/70">
                {takenWasBest ? "Optional context" : "Or log the trade you could have taken"}
              </span>
              <span className="h-px flex-1 bg-border/60" />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="The confluence, level or timing that made this the better trade, and why it was takeable."
                rows={4}
            ...
            <div className="flex items-center gap-2 pt-1">
              {existed && (
                <button
                  ...
                  onClick={remove}
                  disabled={saving}
                  className="rounded-lg border border-border px-3 py-2 text-xs font-medium text-muted-foreground hover:text-destructive hover:border-destructive/30 transition-colors disabled:opacity-50"
                >
                  Clear
                </button>
              )}
