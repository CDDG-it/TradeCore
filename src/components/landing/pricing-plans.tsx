...
type PricingPlan = { name: "Basic" | "Plus" | "Pro"; monthly: number; annual: number; annualMonthly: string; savingsMonths: 2 | 3; description: string; features: readonly string[]; popular?: boolean };

const PLANS: readonly PricingPlan[] = [
  { name: "Basic", monthly: 10, annual: 100, annualMonthly: "8.33", savingsMonths: 2, description: "The essentials for building a consistent trading process.", features: ["1 trading account", "Unlimited trade journal", "Dashboard and core statistics", "5 pre-market exercises / month", "Weekly performance overview"] },
  { name: "Plus", monthly: 20, annual: 180, annualMonthly: "15.00", savingsMonths: 3, description: "For active traders ready to measure and refine their edge.", popular: true, features: ["Everything in Basic", "Up to 5 trading accounts", "Unlimited pre-market exercises", "MC Mindscore", "Habits, goals and commitments", "Advanced analytics and screenshots"] },
  { name: "Pro", monthly: 35, annual: 315, annualMonthly: "26.25", savingsMonths: 3, description: "The complete performance system for serious traders.", features: ["Everything in Plus", "Unlimited trading accounts", "Full MC Trade Therapist", "Best-trade, weekly and monthly reviews", "Monte Carlo evaluation simulator", "Full Global Markets context", "Priority support"] },
] as const;
